...
class Program
{
    ...
    {
        System.Console.WriteLine(@"Du öppnar din sönderörfilade byrå
        och funderar på om du ska örfila den igen");
        string contents = "";
        ...
        while (true)
        {
            ...
            else if (input.ToLower() == "t" || input.ToLower() == "töm")
            {
                ...
                contents = "";
                System.Console.WriteLine($@"Yikes! Innan du hann tömma
                byrån kom en liten strumptjuv och snodde {contents}");
            }
            else
            {
